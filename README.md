...
### JS
Include snazzymenu.min.js and call ```snazzyMenu()``` to initiate.
```html
...
SnazzyMenu is designed to work well with Wordpress sites, following the markup generated by adding standard menu. Follow this markup in your HTML.
